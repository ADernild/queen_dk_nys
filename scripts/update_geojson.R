...
geodata_denmark <- rgdal::readOGR(geofile_denmark, use_iconv = TRUE, encoding = "UTF-8") # Read geojson contents
saveRDS(geodata_denmark, "utils/denmark.geo.rds")
...
saveRDS(geodata_southjutland, "utils/geofile_southjutland.rds")
...
saveRDS(geodata_fyn, "utils/geofile_fyn.rds")
...
saveRDS(geodata_komunes, "utils/geofile_komunes.rds")
