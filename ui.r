              ...
              fluidRow(class="box_align_layout",
                tabBox(width=12, id = "speeches",
                  ...
                  tabPanel("Sentiment relationship (Bubles)",
                           ...
                           whyViz("The sentiment of speeches could indicate influences in topics. Influences from an Article needs to be researched independently."),
